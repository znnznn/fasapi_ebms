...
ebms_session_maker = async_sessionmaker(bind=ebms_engine, autoflush=False, autocommit=False)

default_session_maker = async_sessionmaker(bind=default_engine, autoflush=False, autocommit=False)
